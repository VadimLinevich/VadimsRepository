...
#include <tchar.h>
  ...
  #define _tmain main
#endif
void SetPolinomial1(int *a, int *b, int *c, int *d)//Функция ввода
{
	printf("\nenter a ");
	scanf("%d", &(*a));
	printf("enter b ");
...
void SetPolinomial2(int *a2, int *b2, int *c2, int *d2)//Функция ввода
{
	printf("\nenter a2 ");
	scanf("%d", &(*a2));
	printf("enter b2 ");
...
void GetPolinomial(int a, int b, int c, int d) //функция вывода с учетом значений такие как 0 и 1
{
	if (a == 0)
	{
...
void PolinomialSum(int a, int b, int c, int d, int a1, int b1, int c1, int d1)//Фуекция суммы
{
	int a3, b3, c3, d3;
	a3 = a + a1;
	b3 = b + b1;
...
void PolinomialDif(int a, int b, int c, int d, int a1, int b1, int c1, int d1)//функция разности
{
	int a3, b3, c3, d3, k;
	printf("\n");
    k = 0;
...
void PolinomialMult(int a, int b, int c, int d, int a1, int b1, int c1, int d1)//функция умножения
{
...
void PolinomialSeg(int a, int b, int c, int d, int a1, int b1, int c1, int d1)//функция деления
{
	printf("\n");
    if (a == 0)
	{
